    ...
    <div className="auth-container">
      <div className="auth-card">
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: 700, letterSpacing: '-0.025em', marginBottom: '0.25rem' }}>Welcome Back</h2>
          <p style={{ color: 'var(--text-secondary)' }}>Inventory & Order Management System</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button id="login-submit-btn" type="submit" disabled={submitting} style={{ width: '100%', padding: '0.75rem' }}>
